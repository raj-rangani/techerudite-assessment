            ...
            <div className="flex items-start">
              <div className="text-sm">
                <label htmlFor="terms" className="font-light text-gray-500">
                  ...
                  password) to register as an admin
                </label>
              </div>
            </div>
            <button
              type="submit"
              className="w-full text-white bg-rose-500 hover:bg-rose-600 focus:ring-4 focus:outline-none focus:ring-rose-300 font-semibold rounded-lg text-sm px-5 py-2.5 text-center disabled:bg-rose-600 disabled:text-rose-200 disabled:cursor-not-allowed"
